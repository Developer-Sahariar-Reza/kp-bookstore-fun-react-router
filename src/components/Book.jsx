  ...
  return (
    <Link to={`/book/${book.isbn13}`}>
      <div className="overflow-hidden relative transition duration-200 transform hover:-translate-y-2 shadow-lg hover:shadow-2xl">
        ...
        />
        <div className="bg-black bg-opacity-75 text-gray-300 absolute inset-0 opacity-0 hover:opacity-100 px-6 py-4 rounded-md transition-opacity duration-200 flex flex-col">
          <p>{book.title}</p>
          <br />
